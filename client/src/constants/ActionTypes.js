...
export default {
  ...
  EPIC_CREATE_HANDLE: 'EPIC_CREATE_HANDLE',
  EPIC_UPDATE: 'EPIC_UPDATE',
  EPIC_UPDATE__SUCCESS: 'EPIC_UPDATE__SUCCESS',
  EPIC_UPDATE__FAILURE: 'EPIC_UPDATE__FAILURE',
  EPIC_UPDATE_HANDLE: 'EPIC_UPDATE_HANDLE',
  EPIC_DELETE: 'EPIC_DELETE',
  EPIC_DELETE__SUCCESS: 'EPIC_DELETE__SUCCESS',
  EPIC_DELETE__FAILURE: 'EPIC_DELETE__FAILURE',
  EPIC_DELETE_HANDLE: 'EPIC_DELETE_HANDLE',
  EPIC_TO_BOARD_FILTER_ADD: 'EPIC_TO_BOARD_FILTER_ADD',
  EPIC_FROM_BOARD_FILTER_REMOVE: 'EPIC_FROM_BOARD_FILTER_REMOVE',

  /* Epic comments */

  EPIC_COMMENTS_FETCH: 'EPIC_COMMENTS_FETCH',
  EPIC_COMMENTS_FETCH__SUCCESS: 'EPIC_COMMENTS_FETCH__SUCCESS',
  EPIC_COMMENTS_FETCH__FAILURE: 'EPIC_COMMENTS_FETCH__FAILURE',
  EPIC_COMMENT_CREATE: 'EPIC_COMMENT_CREATE',
  EPIC_COMMENT_CREATE__SUCCESS: 'EPIC_COMMENT_CREATE__SUCCESS',
  EPIC_COMMENT_CREATE__FAILURE: 'EPIC_COMMENT_CREATE__FAILURE',
  EPIC_COMMENT_CREATE_HANDLE: 'EPIC_COMMENT_CREATE_HANDLE',
  EPIC_COMMENT_UPDATE: 'EPIC_COMMENT_UPDATE',
  EPIC_COMMENT_UPDATE__SUCCESS: 'EPIC_COMMENT_UPDATE__SUCCESS',
  EPIC_COMMENT_UPDATE__FAILURE: 'EPIC_COMMENT_UPDATE__FAILURE',
  EPIC_COMMENT_UPDATE_HANDLE: 'EPIC_COMMENT_UPDATE_HANDLE',
  EPIC_COMMENT_DELETE: 'EPIC_COMMENT_DELETE',
  EPIC_COMMENT_DELETE__SUCCESS: 'EPIC_COMMENT_DELETE__SUCCESS',
  EPIC_COMMENT_DELETE__FAILURE: 'EPIC_COMMENT_DELETE__FAILURE',
  EPIC_COMMENT_DELETE_HANDLE: 'EPIC_COMMENT_DELETE_HANDLE',
